                                        ...
                                        <div id="collapseProduct">
                                                        ...
                                                        <div class="row py-2">
                                                            <div class="col-md-6">
                                                                <button type="reset" value="reset"
                                                                        class="btn btn-n btn-outline-danger">
                                                                    Cancelar producto
                                                                </button>
                                                            </div>
                                            ...
                                            <div class="row pt-4">
                                                <div class="col-md-6 offset-md-2 text-right">
                                                    <button type="button" class="btn btn-n btn-outline-danger ml-3"
                                                ...
                                                <div class="col-md-4 text-right">
                                                    @if(count($products) > 0)
                                                        <form method="POST" action="donation/end">
                                                            @csrf
                                                            <button type="submit"
                                                                    class="btn btn-n btn-lg btn-avanzar m-0">Finalizar
                                                                carga de productos<i
                                                                    class="fas fa-arrow-right ml-3 text-white"></i>
                                                            </button>
                                                        </form>
                                                    @else
                                                        <button type="button" class="btn btn-n btn-lg btn-avanzar m-0"
                                                                disabled>Finalizar carga de productos<i
                                                                class="fas fa-arrow-right ml-3 text-white"></i></button>
                                                    @endif
                                                </div>
                                            </div>
                                            <!-- /.Row -->
