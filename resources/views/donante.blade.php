                ...
                <div class="col-md-3 text-right">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" data-toggle="modal" data-target="#logOutModal"><i
                                class="fas fa-power-off mr-1"></i><span>Cerrar sesión</a>
                    </div>
                    <!-- Basic dropdown -->
                </div>
            </div>
                        ...
                        <div class="col-md-3 p-0">
                            <div class="shadow-none m-0 p-0">
                                ...
                                <ul class="list-group list-group-flush menu-panel">
                                    <!-- Crear una donación -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(0)"><i
                                            class="fas fa-plus-square mr-2 p-2"></i><span>Crear una donación</span></li>
                                    <!-- Ver donaciones vigentes -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(1)"><i
                                            class="fas fa-box-open mr-2 p-2"></i><span>Ver donaciones vigentes</span>
                                    </li>
                                    <!-- Ver donaciones pasadas -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(2)"><i
                                            class="fas fa-box mr-2 p-2"></i><span>Ver donaciones pasadas</span></li>
                                    <!-- Ver donaciones rechazadas -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(3)"><i
                                            class="fas fa-ban mr-2 p-2"></i><span>Ver donaciones rechazadas</span></li>
                                    <!-- Modificar perfil -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(4)"><i
                                            class="far fa-user-circle mr-2 p-2"></i><span>Modificar perfil</span></li>
                                    <!-- Cambiar contraseña -->
                                    <li class="list-group-item menuItem" onclick="panelSwitch(5)"><i
                                            class="fas fa-unlock-alt mr-2 p-2"></i><span>Cambiar contraseña</span></li>
                                    <!-- Cerrar sesión -->
                                    <a href="{{ route('logout') }}" class="list-group-item menuItem"
                                       onclick="event.preventDefault();
                                                    document.getElementById('logout-form').submit();"><i
                                            class="fas fa-power-off mr-2 p-2"></i>
                                        {{ __('Cerrar sesión') }}
                                    </a>
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST"
                                          style="display: none;">
                                        ...
                                        <div class="col-md-8">
                                            <div class="accordion" id="productAccordion">
                                                <div id="headingProduct">
                                                    <h4 class="cursor-p add-product" data-toggle="collapse"
                                                        data-target="#collapseProduct" aria-expanded="true"
                                                        aria-controls="collapseProduct">Agregar un nuevo producto<i
                                                            class="fas fa-plus-square ml-2 p-2"></i></h4>
                                                </div>
                                                <div id="collapseProduct" class="collapse"
                                                     aria-labelledby="headingProduct" data-parent="#productAccordion">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="dynamic_field">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><select id="category" type="text"
                                                                    ...
                                                                    <td><input type="date" name="expiration_date[]"
                                                                               class="form-control name_list"/></td>
                                                                    <td>
                                                                        <button type="button" name="add" id="add"
                                                                                class="btn btn-success">Agregar otro
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <label for="date_of_delivery">Fecha y hora de
                                                                entrega:</label>
                                                            <input type="datetime-local" name="date_of_delivery">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <label for="address-street"
                                                               class="req-tooltip">Calle @include('components.required_tool')</label>

                                                        <input id="address-street" type="text"
                                                               class="form-control @error('address-street') is-invalid @enderror"
                                                               name="address-street" placeholder="Avenida xx"
                                                    ...
                                                    <div class="col-md-5">
                                                        <label for="address-number"
                                                               class="req-tooltip">Número @include('components.required_tool')</label>

                                                        <input id="address-number" type="number"
                                                               class="form-control @error('address-number') is-invalid @enderror"
                                                               name="address-number" placeholder="xxx"
                                                               value="{{ $giver->first()->address_number }}" required
                                                               autocomplete="address-number" autofocus>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input id="address-floor" type="number"
                                                               class="form-control @error('address-floor') is-invalid @enderror"
                                                               name="address-floor" placeholder="xx"
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input id="address-apartment" type="text"
                                                               ...
                                                               name="address-apartment" placeholder="xx"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <label for="neighborhood"
                                                               class="req-tooltip">Barrio @include('components.required_tool')</label>

                                                        <select id="neighborhood" type="text"
                                                                ...
                                                                autocomplete="neighborhood" required autofocus>
                                            ...
                                            <div class="col-md-6 bl-1">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input id="dni" type="number"
                                                               ...
                                                               name="dni" placeholder="xxxxxxxx"
                                                               value="{{ $user->dni }}" required autocomplete="dni"
                                                               autofocus>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input id="phone" type="number"
                                                               ...
                                                               name="phone" placeholder="xxxxxxxx"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <label for="email"
                                                               class="req-tooltip">Email @include('components.required_tool')</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row pt-3 mb-0">
                                                    <div class="col-md-3 text-left offset-md-6">
                                                        <button type="button" class="btn btn-outline-danger btn-n m-0"
                                                                data-toggle="modal"
                                                                data-target="#cancelarModificarPerfil">
                                                            Cancelar
                                                        </button>
                                                    </div>
                                                    <div class="col-md-3 text-right">
                                            ...
                                            <form method="post" action="/change_password" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row pt-5 mb-0">
                                                    <div class="col-md-6 text-left">
                                                        <button type="button" class="btn btn-outline-danger btn-n m-0"
                                                                data-toggle="modal"
                                                                data-target="#cancelarCambiarContraseña">
                                                            Cancelar
                                                        </button>
                                                    </div>
